...
class Category extends Admin_Controller
{
    ...
    public function index()
    {
        ...
        $this->breadcrumbs->admin_push('Customer List', 'Customer');
    ...
    public function add()
    {
        $this->layout->set_title('Add Customer');
        $this->breadcrumbs->admin_push('Dashboard', 'dashboard');
        $this->breadcrumbs->admin_push('Customer List', 'Customer');
        $this->breadcrumbs->admin_push('Add Customer', 'Customer/add');
        $data = array(
            'button' => 'Add',
    ...
    public function add_category()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
          ...
          if($result){
            ...
            $this->session->set_flashdata(array('message'=>'Customer Added Successfully','type'=>'success'));
          }else {
    ...
    public function edit($id)
    {
        if(check_post()){
          ...
          if($result){
            $this->session->set_flashdata(array('message'=>'Customer updated Successfully','type'=>'success'));
          }else {
            $this->session->set_flashdata(array('message'=>'Something went wrong. Try again','type'=>'warning'));
          }
          redirectToAdmin('category');
    ...
    public function delete()
    {
      ...
      if($result){
        ...
        echo json_encode(array('message'=>'Customer deleted Successfully','type'=>'success'));
      }else {
