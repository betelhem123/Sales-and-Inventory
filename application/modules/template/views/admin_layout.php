  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?=admin_url("dashboard")?>">
        ...
        <div class="sidebar-brand-text mx-3">ZALA</div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseCategory" <?php if($this->router->class=="category"){ echo 'class="collapse show"';}else{ echo 'class="collapse"';} ?> aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <a <?php if($this->router->method=="index" OR $this->router->method=="edit"){ echo 'class="collapse-item active"';}else{ echo 'class="collapse-item"';}?>  href="<?=admin_url('category')?>">customer List</a>
            <a <?php if($this->router->method=="add"){ echo 'class="collapse-item active"';}else{ echo 'class="collapse-item"';}?>  href="<?=admin_url('category/add')?>">Add customer</a>
          </div>
        </div>
      </li>
      <li class="nav-item">
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span> &copy;  Zala Sales & Inventory System - <?php echo date("Y"); ?></span><br/> <br/>
            <span></span>
          </div>
        </div>
      </footer>
